...
export default function ComplaintSuccess(props) {
...
const notify = (message) => toast(message);
     ...
     return (
        <ClientLayout width='100%' showCurvedFooter={false} showFooter={false} showBackgroundImage={false} backgroundColor="white" height="100%">
            ...
            <h1 className="reg__header">Complaint Successful</h1>
           <p className="reg__description">Your Complaint has been successfully sent.</p>
