...
<img src={top} className="imgTop" style={{width:'20%'}}/>
            <h1 className="reg__header">Password Reset Successful</h1>
           <p className="reg__description">Your Password has been reset Successfully</p>
           <div className="form__column_button">
            <button className="form__button" onClick={logOut}>Proceed to Login</button>
</div>
